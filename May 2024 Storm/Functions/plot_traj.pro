...
datarootdir='C:\Users\dswanson\Documents\Files\Satellites\LLITED\06 data\MIGSI\L3\'

file =['LLITEDB_MIGSI_20240507_033038_L3_v01.nc',$
  'LLITEDB_MIGSI_20240508_094038_L3_v01.nc',$
  'LLITEDB_MIGSI_20240510_094038_L3_v01.nc',$
  'LLITEDB_MIGSI_20240511_050238_L3_v01.nc',$
  'LLITEDB_MIGSI_20240512_094038_L3_v01.nc',$
  'LLITEDB_MIGSI_20240513_050138_L3_v01.nc']

files = datarootdir+file
...
sc='B' &$
;SH
  migsi1=read_migsi_l3file(file=files(SH(0))) &$
  migsi2=read_migsi_l3file(file=files(SH(1))) &$
  migsi3=read_migsi_l3file(file=files(SH(2))) &$
;NH  
  migsi4=read_migsi_l3file(file=files(NH(0))) &$
  migsi5=read_migsi_l3file(file=files(NH(1))) &$
  migsi6=read_migsi_l3file(file=files(NH(2))) &$
